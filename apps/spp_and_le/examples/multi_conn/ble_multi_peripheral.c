...
static int multi_make_set_adv_data(void)
{
    ...
    info[4] = 0x03;
    info[5] = 0x5D;
    info[6] = 0x70; // 原本的广播头，但是对应的app功能不对
    ...
    // info[6] = 0x00;
    // info[7] = 0xd9;
    // le_controller_get_mac(&info[8]);    //获取ble的蓝牙public地址
    // offset += make_eir_packet_data(&buf[offset],offset,HCI_EIR_DATATYPE_MANUFACTURER_SPECIFIC_DATA,info,14);
